...
const T = {
  ...
  ur: {
    ...
    smalltalk: () => `خوش آمدید! 🙂 میں آپ کی مدد کے لیے حاضر ہوں — Gold، BTC، آپ کے کسی trade، یا کچھ نیا سیکھنے میں۔ بتائیں آپ کیا دیکھنا چاہیں گے؟`,
  ...
  'ur-roman': {
    ...
    smalltalk: () => `Khush aamdeed! 🙂 Main aap ki madad ke liye hazir hoon — Gold, BTC, aap ke kisi trade, ya kuch naya seekhne mein. Bataiye aap kya dekhna chahenge?`,
  ...
  ar: {
    ...
    smalltalk: () => `أهلاً بك! 🙂 أنا هنا لمساعدتك — في Gold أو BTC أو صفقة تفكّر بها أو تعلّم شيء جديد. ماذا تريد أن نتناول؟`,
